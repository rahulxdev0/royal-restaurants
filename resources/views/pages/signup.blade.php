...
@section('content')
    <div class="min-h-screen bg-[#000] flex items-center justify-center p-4">
        <div class="w-full max-w-md bg-white/10 backdrop-blur-lg rounded-2xl shadow-xl p-8 space-y-6 border border-white/20">
            <div class="text-center">
                <h1 class="text-3xl font-bold text-white mb-2">Create Account</h1>
                <p class="text-white/80">Join our community to get started</p>
            </div>
            ...
            <form action="{{ route('register') }}" class="space-y-5" method="POST">
                ...
                <div class="space-y-4">
                    ...
                    <div class="relative">
                        <input type="password" id="confirm_password" name="password_confirmation" required placeholder="Enter your password"
                            class="w-full px-4 py-3 bg-white/5 backdrop-blur-sm border border-white/20 rounded-lg text-white placeholder:text-white/20 focus:border-white/40 focus:ring-2 focus:ring-white/20 focus:outline-none transition-all" />
                ...
                <p class="text-center text-white/80">
                    ...
                    <a href="{{ route('login') }}" class="text-white hover:text-white/90 underline underline-offset-4">Sign in</a>
                </p>
            </form>
        </div>
    </div>
